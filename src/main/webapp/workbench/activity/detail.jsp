...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.success){
                        ...
                        html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small style="color: gray;"> '+(data.ar.createTime)+' 由 '+(data.ar.createBy)+'创建</small>';
	...
	function showRemarkList() {
		$.ajax({
			...
			data:{
				"activityId":"${a.id}"  //js中，el表达式必须套在双引号中
			},
			type:"get",
			dataType:"json",
			success:function (data) {
	...
	function editRemark(id) {
		...
		//将标签中展现出来的信息，赋予到修改操作模态窗口的文本域中
			$("#noteContent").val(noteContent);

		//信息处理完毕后，将修改备注的模态窗口打开
